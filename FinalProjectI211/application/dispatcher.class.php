 ...
 * A typical url looks like this: http://example.com/kungfupanda/recipe/view/1.
 * In this url, recipe is the controller, view is the method, and 1 is the parameter.
 */

//nothing needs to really be changed here since the dispatcher automatically breaks up the url into strings and hides the directory
//Not to mention the way the dispatcher was constructed is really well done. louie made the dispatcher to automatically name classes in the controller using the action we send.
//All that needs to be done is change welcome controller or make a welcome controller in our webpage to have a home page. since the dispatcher detaults to useing welcomecontroller class in the url on start up.
