...
class CakeModel
{
    ...
    public static function getCakeModel()
    {
        if (self::$_instance == NULL) {
            self::$_instance = new CakeModel();
        }
    ...
    public function listCakeRecipes()
    {
        ...
        $sql = "SELECT * FROM " . $this->tblRecipes .  " WHERE " . $this->tblRecipes . ".Category= 'Cake'";
...
//        $sql = "SELECT * FROM submissions,users WHERE Submission_id = $id  AND submissions.id=users.id";
    ...
    public function searchRecipe($terms)
    {
        ...
        $sql = "SELECT * FROM " . $this->tblRecipes . " WHERE " . $this->tblRecipes . ".Category= 'Cake' AND " . $this->tblRecipes . ".id=" . $this->tblRecipes . ".id AND (1";
