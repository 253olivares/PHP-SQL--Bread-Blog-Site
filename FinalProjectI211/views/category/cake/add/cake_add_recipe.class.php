 ...
 * Date: 4/20/2020
 * File: cake_add_recipe.class.php
 * Description: this is the view class for adding cake recipe
 *
 */

class CakeAddRecipe extends CakeNav
{
    public function display()
    {
        parent::displayHeader('Bakers Center Cake Recipe');
        $login_status = " ";
        $user_id = 0;
        $user_name = " ";
        ...
        if ($login_status == "1") {
            ...
            <div class="top-row" style="text-align: center">
                <h1>Create New Cake Recipe</h1>
            </div>
            <br>
            <div class="middle-row">
                <form action="<?= BASE_URL ?>/cake/register" method="post">
                    <div class="food">
...
Step 2) directions for what to do in step 2"
                    ...
                    <div class="editButton">
                        ...
                        <input style="float: right" type="button" value="cancel"
                               onclick='window.location.href = "<?= BASE_URL ?>/cake/index/"'>
                    </div>
