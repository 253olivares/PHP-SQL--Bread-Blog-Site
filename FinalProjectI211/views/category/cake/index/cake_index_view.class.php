 ...
 * Date: 4/20/2020
 * File: cake_index.class.php
 * Description:this is our index page that displays
 */

class CakeIndex extends CakeNav
{
    public function display($recipes)
    {
        parent::displayHeader('Bakers Center Cake Recipes Catalog');
        ?>
        <div>
        ...
        if ($login_status == 1) {
            ?>
            <div class="addRecipeContainer" onclick="window.open('<?= BASE_URL ?>/cake/add','_self')">
