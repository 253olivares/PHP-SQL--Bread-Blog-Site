...
class CookieIndex extends CookieNav
{
    public function display($recipes)
    {
        parent::displayHeader('Bakers Center Cookie Recipes Catalog');
        ?>
        <div>
        ...
        <div style="width: 100%; margin-top: 40px">
            <div id="searchbar" style="width:402px;margin:auto;">
                <form method="get" action="<?= BASE_URL ?>/cookie/search">
        ...
        if ($login_status == 1) {
            ?>
            <div class="addRecipeContainer" onclick="window.open('<?= BASE_URL ?>/cookie/add','_self')">
        ...
        <div class="recipeList">
            ...
            if ($recipes === 0) {
                ...
                foreach ($recipes as $i => $recipe) {
                    ...
                    ?>
                    <div class="recipeHolder" onclick="window.open('<?= BASE_URL ?>/cookie/detail/<?= $id ?>','_self')">
