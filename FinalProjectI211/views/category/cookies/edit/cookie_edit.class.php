 ...
 * Author: "Justin Rice"
 * Date: 4/28/2020
 * File: cookie_edit.class.php
 * Description:
 */

class CookieEdit extends CookieNav
{

    public function display($recipe)
    {
        parent::displayHeader("Cookie Recipe Edit Page");
        ...
        if ($userID == 5 || $userID == $authorID) {
            ...
            <div class="middle-row">
                <form action="<?= BASE_URL ?>/cookie/update/<?= $id ?>" method="post">
                    <div class="food">
                        <img src="<?= $image ?>">
                    </div>
                    <div class="detail">
                    ...
                    <div class="editButton">
                        ...
                        <input style="float: right" type="button" value="cancel" onclick='window.location.href = "<?= BASE_URL . "/cookie/detail/" . $id ?>"'>
                    </div>
