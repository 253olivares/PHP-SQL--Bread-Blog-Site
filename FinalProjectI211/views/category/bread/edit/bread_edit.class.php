 ...
 * Date: 4/28/2020
 * File: bread_edit.class.php
 * Description:
 */

class BreadEdit extends BreadNav
{

    public function display($recipe)
    {
        parent::displayHeader("Bread Recipe Edit Page");
        ...
        if ($userID == 5 || $userID == $authorID) {
            ...
            <div class="middle-row">
                <form action="<?= BASE_URL ?>/bread/update/<?= $id ?>" method="post">
                    <div class="food">
                        <img src="<?= $image ?>">
                    </div>
                    <div class="detail">
                    ...
                    <div class="editButton">
                        ...
                        <input style="float: right" type="button" value="Cancel" onclick='window.location.href = "<?= BASE_URL . "/bread/detail/" . $id ?>"'>
                    </div>
