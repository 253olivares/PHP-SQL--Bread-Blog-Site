 ...
 * Date: 4/28/2020
 * File: bread_add_recipe.class.php
 * Description:
 */

class BreadAddRecipe extends BreadNav
{
    public function display()
    {
        ...
        if ($login_status == "1") {
            ...
            <div class="top-row" style="text-align: center">
                <h1>Create New Bread Recipe</h1>
            </div>
            <br>
            <div class="middle-row">
                <form action="<?= BASE_URL ?>/bread/register" method="post">
                    <div class="food">
...
Step 2) directions for what to do in step 2"
                    ...
                    <div class="editButton">
                        ...
                        <input style="float: right" type="button" value="cancel"
                               onclick='window.location.href = "<?= BASE_URL ?>/bread/index/"'>
                    </div>
