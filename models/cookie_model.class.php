...
{    //sets attributes to connect to database
    ...
    public static function getCookieModel()
    {
    ...
    public function listCookieRecipes()
    {
        //our try here check to make sure our sql works
        try {

            $sql = "SELECT * FROM " . $this->tblRecipes . " WHERE " . $this->tblRecipes . ".Category= 'Cookie'";
...
//        $sql = "SELECT * FROM submissions,users WHERE Submission_id = $id  AND submissions.id=users.id";
    ...
    public function searchRecipe($terms)
    {
        ...
        $sql = "SELECT * FROM " . $this->tblRecipes . " WHERE " . $this->tblRecipes . ".Category= 'Cookie' AND " . $this->tblRecipes . ".id=" . $this->tblRecipes . ".id AND (1";
