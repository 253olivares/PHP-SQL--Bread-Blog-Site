...
class AddRecipe extends AllNav
{
    public function display()
    {
        parent::displayHeader('Bakers Center Add Recipe');
        $login_status = " ";
        $user_id = 0;
        $user_name = " ";
        ...
        if ($login_status == "1") {
            ...
            <div class="middle-row">
                    <form action="<?= BASE_URL ?>/all/register" method="post">
                    <div class="food">
...
Step 2) directions for what to do in step 2"
                    ...
                    <div class="editButton">
                        ...
                        <input style="float: right" type="button" value="cancel"
                               onclick='window.location.href = "<?= BASE_URL ?>/all/index/"'>
                    </div>
