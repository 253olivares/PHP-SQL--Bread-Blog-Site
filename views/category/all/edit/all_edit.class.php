...
class AllEdit extends AllNav
{
    public function display($recipe)
    {
        parent::displayHeader("Recipe Edit Page");
        ...
        if ($userID == 5 || $userID == $authorID) {
            ...
            <div class="middle-row">
                <form action="<?= BASE_URL ?>/all/update/<?= $id ?>" method="post">
                    <div class="food">
                        <img src="<?= $image ?>">
                    </div>
                    <div class="detail">
                    ...
                    <div class="editButton">
                        ...
                        <input style="float: right" type="button" value="cancel" onclick='window.location.href = "<?= BASE_URL . "/all/detail/" . $id ?>"'>
                    </div>
            ...
            <div style=" width: 50%; margin: auto; text-align: center;margin-top: 25%;">
                <h1>You do not hve permission to edit this recipe. Please log in as admin or author of the recipe to
                    edit.</h1>
            </div>
