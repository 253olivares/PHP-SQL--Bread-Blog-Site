 ...
 */
var xmlHttp;
var numNames = 0;  //total number of suggested celebrities
var activeName = -1;  //celebrity currently being selected
...
function displayNames(names) {
    ...
    var divContent = "";
    //retrieve the names from the JSON doc and create a new span for each name
